# Generated by Django 4.1 on 2023-04-07 19:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Journals', 'Journals'), ('Magazines', 'Magazines'), ('Books', 'Books'), ('Newspapers', 'Newspapers'), ('Brochures', 'Brochures'), ('Other papers', 'Other papers')], default='Journals', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, help_text='Choose resource author', null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.libraryauthor', verbose_name='Author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to='uploads/resources', verbose_name='Resource file')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Date of creation')),
                ('topic', models.CharField(help_text='Enter topic', max_length=45, unique=True, verbose_name='Topic')),
                ('cover', models.ImageField(blank=True, null=True, upload_to='uploads/resource_covers', verbose_name='Subresource cover')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en_subtitle', models.TextField(help_text='Enter subtitle', max_length=100, verbose_name='English subtitle')),
                ('uk_subtitle', models.TextField(help_text='Enter subtitle', max_length=100, verbose_name='Ukrainian subtitle')),
