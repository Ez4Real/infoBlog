    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('pc', 'Podcast'), ('vd', 'Video')], help_text='Choose video type', max_length=2)),
                ('url_path', models.URLField(help_text='Video URL path', verbose_name='Content')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en_subtitle', models.TextField(help_text='Enter subtitle', max_length=150, verbose_name='English subtitle')),
                ('uk_subtitle', models.TextField(help_text='Enter subtitle', max_length=150, verbose_name='Ukrainian subtitle')),
